    ...
    bool allowAnonymous = false)
{
    ...
    {
        if (!context.Request.Headers.TryGetValue("Authorization", out var authorizationHeader)) return false;
    ...
    {
        if (!context.Request.Headers.TryGetValue("X-API-KEY", out var apiKeyHeader)) return false;
